...
namespace core.Dtos
{
    public class VoucherToAddDto
	{
		public VoucherToAddDto()
		{
		}

		public VoucherToAddDto(int id, string divn, int voucherNo, DateTime voucherDated, int coaid, long amount, string narration, 
